...
export default function Icon({ name, size = 20, className = '' }) {
  const icons = {
    ...
    manufacturers:<><rect x="2" y="7" width="20" height="14" rx="2"/><path d="M16 7V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v2M12 12v4m-2-2h4"/></>,
    ...
    suppliers:    <><path d="M3 9h18M3 15h18M3 9l3-6h12l3 6M3 15l3 6h12l3-6"/></>,
    ...
    zigzagUp:     <><path d="m3 17 4-4 4 4 8-8"/><path d="M13 7h6v6"/></>,
    zigzagDown:   <><path d="m3 7 4 4 4-4 8 8"/><path d="M13 17h6v-6"/></>,
    ...
    trash:        <><path d="M3 6h18m-2 0v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/><path d="M10 11v6m4-6v6"/></>,
